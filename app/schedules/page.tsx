            ...
            <table className="w-full text-sm text-left text-gray-600">
              ...
              <tbody>
                {schedules.map((schedule) => (
                  <tr key={schedule.id} className="bg-white border-b last:border-0 hover:bg-gray-50" data-testid="schedule-card">
                    ...
                    <td className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap">
                      <Link href={`/files/${schedule.file.id}`} className="text-blue-600 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500">
                        {schedule.file.name}
                      </Link>
                    </td>
                    ...
                    <td className="px-6 py-4 text-right">
                      <Link href={`/files/${schedule.file.id}`} className="font-medium text-blue-600 hover:underline focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-blue-500">
                        Edit
                      </Link>
                    </td>
                  </tr>
